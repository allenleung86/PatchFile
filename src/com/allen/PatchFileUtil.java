...
public class PatchFileUtil {
	public static String patchFile = "D:\\Users\\user\\Desktop\\patch.txt"; //补丁文件,由eclipse svn plugin生成
	public static String projectPath = "C:\\file\\Workspaces\\EclipseLuna\\paohe"; //项目文件夹路径
	//public static String projectPath = "C:\\file\\Workspaces\\EclipseLuna\\trace"; //项目文件夹路径
	public static String webContent = "WebRoot"; //web应用文件夹名
	public static String classPath = "C:\\file\\Workspaces\\EclipseLuna\\paohe\\WebRoot\\WEB-INF\\classes"; //class存放路径
	public static String desPath = "D:\\Users\\user\\Desktop\\patch";// 补丁文件包存放路径
	public static String version = "patch_lzl_" + getNowDate();// 补丁版本
